##3-DOF RPP Cylindrical Manipulator (Group 16_MEXE3203)
...
Main_layout = [
    [sg.Push(), sg.Text('Cylindrical RPP MEXE Calculator', font = ("Monotype Corsiva", 15)), sg.Push()],

    [sg.Text('Forward Kinematics Calculator', font = ("Cascadia Code", 12))],
    [sg.Text('Fill out the following fields:', font=("Cascadia Code", 10)),
     sg.Push(), sg.Button('Click this before Solving Forward Kinematics', font=("Cascadia Code", 12), size=(35, 0), button_color=('white', 'purple')),
     sg.Push(),
     sg.Text('OR', font = ("Cascadia Code", 12)),
     sg.Push(), sg.Button('Solve Inverse Kinematics', font = ("Cascadia Code", 12), size=(35,0), button_color=('black', 'pink')), sg.Push()],

    [sg.Text('a1 = ', font = ("Cascadia Code" , 10)),sg.InputText('55', key='a1', size=(20,10)),
     sg.Text('T1 = ', font = ("Cascadia Code", 10)),sg.InputText('0', key= 'T1', size=(20,10)),
     sg.Push(), sg.Button('Jacobian Matrix (J)', disabled=True, font = ("Cascadia Code", 12), size=(15,0), button_color=('white', 'green')),
     sg.Button('Det(J)', disabled=True, font = ("Cascadia Code", 12), size=(15,0), button_color=('white', 'green')),
     sg.Button('Inverse of J', disabled=True, font = ("Cascadia Code", 12), size=(15,0), button_color=('white', 'green')),
     sg.Button('Transpose of J', disabled=True, font = ("Cascadia Code", 12), size=(15,0), button_color=('white', 'green')), sg.Push()],

    [sg.Text('a2 = ', font = ('Cascadia Code', 10)),sg.InputText('60', key='a2', size=(20,10)),
     sg.Text('d2 = ', font = ('Cascadia Code', 10)),sg.InputText('0', key='d2', size=(20,10))],

    [sg.Text('a3 = ', font=('Cascadia Code', 10)), sg.InputText('30', key='a3', size=(20, 10)),
     sg.Text('d3 = ', font=('Cascadia Code', 10)), sg.InputText('0', key='d3', size=(20, 10)),
     sg.Push(), sg.Button('Inverse Kinematics', font = ('Cascadia Code', 12), size=(35,0), button_color=('black', 'pink')), sg.Push()],

    [sg.Button('Solve Forward Kinematics', disabled=True, tooltip= 'Go first to "Click this before Solving Forward Kinematics"!',
                 font = ('Cascadia Code', 12), button_color=('white', 'orange')), sg.Push()],
     

    [sg.Frame('Position Vector: ',[[
        sg.Text('X = ', font = ("Cascadia Code", 10)), sg.InputText(key='X', size=(10,1)),
        sg.Text('Y = ', font = ("Cascadia Code", 10)), sg.InputText(key='Y', size=(10,1)),
        sg.Text('Z = ', font = ("Cascadia Code", 10)), sg.InputText(key='Z', size=(10,1))]])],

    [sg.Push(), sg.Frame('HO_3 Transformation Matrix = ', [[sg.Output(size=(60, 12))]]),
     sg.Push(), sg.Image('CYLINDRICAL.png'), sg.Push()],

    [sg.Submit(font=("Cascadia Code", 10)), sg.Exit(font=("Cascadia Code", 10))]]

# Window Code
window = sg.Window('CYLINDRICAL MEXE CALCULATOR', Main_layout, resizable=True)
...
def Inverse_Kinematics_window():
    ...
    EXCEL_FILE = 'CYLINDRICAL_IK.xlsx'
    IK_df = pd.read_excel(EXCEL_FILE)

    IK_layout = [
        [sg.Push(),sg.Text('Inverse Kinematics', font = ("Cascadia Code", 12)),sg.Push()],
        [sg.Text('Fill out the following fields:', font = ("Cascadia Code", 10))],
        [sg.Text('a1 = ', font = ("Cascadia Code", 10)),sg.InputText('0', key='a1', size=(8,10)),
        sg.Text('mm',font = ("Cascadia Code", 10)),
            sg.Text('X = ', font = ("Cascadia Code", 10)),sg.InputText('0',key='X', size=(8,10)),
            sg.Text('mm' ,font = ("Cascadia Code", 10))],
        [sg.Text('a2 = ', font = ("Cascadia Code", 10)),sg.InputText('0', key='a2', size=(8,10)),
        sg.Text('mm',font = ("Cascadia Code", 10)),
            sg.Text('Y = ' , font = ("Cascadia Code", 10)),sg.InputText('0',key='Y' , size=(8,10)),
            sg.Text('mm',font = ("Cascadia Code", 10))],
        [sg.Text('a3 = ', font = ("Cascadia Code", 10)),sg.InputText('0', key='a3', size=(8,10)),
         sg.Text('mm',font = ("Cascadia Code", 10)),
            sg.Text('Z = ' ,font = ("Cascadia Code", 10)),sg.InputText('0',key='Z' , size=(8,10)),
            sg.Text('mm' ,font = ("Cascadia Code", 10))],
        [sg.Button('Solve Inverse Kinematics', font = ("Cascadia Code", 12), button_color=('red', 'white')), sg.Push()],

        [sg.Frame('Position Vector: ',[[
            sg.Text('Th1 = ' , font = ("Cascadia Code", 10)),sg.InputText(key='IK_Th1', size=(10,1)),
            sg.Text('degrees',font = ("Cascadia Code", 10)),
            sg.Text('d2 = ', font = ("Cascadia Code", 10)),sg.InputText(key='IK_d2', size=(10,1)),
            sg.Text('mm',font = ("Cascadia Code", 10)),
            sg.Text('d3 = ' , font = ("Cascadia Code", 10)),sg.InputText(key='IK_d3', size=(10,1)),
            sg.Text('mm',font = ("Cascadia Code", 10)),]])],
            [sg.Submit(font = ("Cascadia", 10)),sg.Exit(font = ("Cascadia Code", 10))]
    ]
    ...
    while True:
        ...
        if event == sg.WIN_CLOSED or event == 'Exit' :
            ...
            Inverse_Kinematics_window['IK_Th1'].update(np.around(Th1, 3))
